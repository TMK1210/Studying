...
int main(){
    ...
    cout << "Enter pounds: "; cin >> pounds; /*1 pound = 20 shillings = 240 pence*/
    cout << "Enter shillings: "; cin >> shillings;
    cout << "Enter pence: "; cin >> pence;
    float all_pence = pence + (pounds * 20 + shillings) * 12; 
    float decimal_pounds = all_pence / 240;
    cout << "Decimal pound: " << "£" << decimal_pounds << endl;
    return 0;
}