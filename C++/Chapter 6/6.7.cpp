...
int main(){
    Angle a1(137, 32, 'S'); char choice = 'y';
    a1.display();
    Angle a2;
    cout << "Enter an angle value (in degrees and minutes) and a direction." << endl;
    cout << "Example: 149°34.8' W, 17°31.5' S" << endl;
    do{
        a2.obtain();
        a2.display();

        cout << "Continue? y/n. Other answers will be consider 'y' "; cin >> choice;
    } while (choice != 'n');
    return 0;
}